...
class TestTemplate:
    ...
    def test_cite_web_from_easter_island(self):
        ...
        for template in templates:
            ...
            assert wt.parameters["url"] == ("http://www.ine.cl/canales/chile_estadistico/censos_poblacion_"
                                            "vivienda/censo_pobl_vivi.php")
            assert wt.parameters["archive_url"] == ("https://web.archive.org/web/20100715195638/http://www.ine.cl/c"
