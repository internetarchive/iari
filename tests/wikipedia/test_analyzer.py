            ...
            references=[
                ReferenceStatistics(
                    ...
                    wikitext=(
                        ...
                        "http://www.ine.cl/canales/chile_estadistico/censos_poblacion_vivienda/"
                        "censo_pobl_vivi.php | "
                        ...
                        "archive-url= https://web.archive.org/web/20100715195638/"
                        "http://www.ine.cl/canales/chile_estadistico/censos_poblacion_vivienda/"
                ...
                ReferenceStatistics(
                    ...
                    is_named_reference=False,
                    wikitext=(
                        "<ref>{{cite web |language= es |url= https://resultados.censo2017.cl/Home/Download |"
                        "title= Censo 2017 |work= [[National Statistics Institute ("
                        "Chile)|National Statistics Institute]] |"
                        "access-date= 11 May 2018 |archive-url= https://web.archive.org/web/20180511145942/"
                        "https://resultados.censo2017.cl/Home/Download |archive-date= 11 May 2018 |"
                        "url-status=dead }}</ref>"
                    ),
                ),
                ReferenceStatistics(
