    ...
    def test_remove_comments_from_template(self):
        ...
        assert extract_templates_and_params(data, True) == [
            (
                ...
                "{{url|1=https://books.google.com/books?id=28tmAAAAMAAJ&pg=PR7 <!--|alternate-full-text-url=https://babel.hathitrust.org/cgi/pt?id=mdp.39015027915100&view=1up&seq=11 -->}}"
            )
        ]
