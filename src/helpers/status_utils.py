...
@staticmethod
def get_live_status(url, status_method: UrlStatusMethod, force_refresh=False):
    results = {
        "status_code", 999  # placeholder
    }
    return results
...
#             """
#
#             new_data = StatusUtils.get_live_status_data(url_link, status_method)
...
#
#     @staticmethod
#     def get_live_status_data(url, status_method):
#         """
...
#             own modules, and we can select which one to use with the Strategy pattern
#
#         This uses wayback machine's Live Web Checker
#         response looks like:
#         {
