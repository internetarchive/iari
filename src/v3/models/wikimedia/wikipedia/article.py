...
from src.v3.models.exceptions import MissingInformationError, WikipediaApiFetchError
from src.v3.models.wikimedia.enums import WikimediaDomain
...
class WikipediaArticle(WariBaseModel):
    ...
    def fetch_and_extract_and_parse(self):
        ...
        if self.is_redirect:
            ...
            # print(self.wikitext)
            from src.v3.models.wikimedia.wikipedia.reference.extractor import (
