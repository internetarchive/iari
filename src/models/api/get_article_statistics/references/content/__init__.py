...
from src.models.api.get_article_statistics.references.content.citation_references import (
    CitationReferences,
)
from src.models.api.get_article_statistics.references.content.general_references import (
    GeneralReferences,
)
